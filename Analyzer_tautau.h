...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual vector<int> getTauCand_1(double pt, double eta);
   virtual vector<int> getTauCand_2(double pt, double eta, int skip_me);
...
void Analyzer_tautau::Init(TChain *tree)
{
