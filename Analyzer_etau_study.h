...
#ifndef Analyzer_etau_study_h
#define Analyzer_etau_study_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   Analyzer_etau_study(TTree *tree=0);
   Analyzer_etau_study(const char* file1, const char* file2);
   virtual ~Analyzer_etau_study();
...
#ifdef Analyzer_etau_study_cxx
Analyzer_etau_study::Analyzer_etau_study(const char* file1, const char* file2)
{
...
Analyzer_etau_study::~Analyzer_etau_study()
{
   if (!fChain) return;
...
Int_t Analyzer_etau_study::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analyzer_etau_study::LoadTree(Long64_t entry)
{
...
void Analyzer_etau_study::Init(TChain *tree)
{
...
Bool_t Analyzer_etau_study::Notify()
{
...
void Analyzer_etau_study::Show(Long64_t entry)
{
...
Int_t Analyzer_etau_study::Cut(Long64_t entry)
{
...
#endif // #ifdef Analyzer_etau_study_cxx
