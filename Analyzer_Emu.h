...
#ifndef Analyzer_Emu_h
#define Analyzer_Emu_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   Analyzer_Emu(TTree *tree=0);
   Analyzer_Emu(const char* file1, const char* file2);
   virtual ~Analyzer_Emu();
...
#ifdef Analyzer_Emu_cxx
Analyzer_Emu::Analyzer_Emu(const char* file1, const char* file2)
{
...
Int_t Analyzer_Emu::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analyzer_Emu::LoadTree(Long64_t entry)
{
...
void Analyzer_Emu::Init(TChain *tree)
{
...
void Analyzer_Emu::Show(Long64_t entry)
{
...
Int_t Analyzer_Emu::Cut(Long64_t entry)
{
