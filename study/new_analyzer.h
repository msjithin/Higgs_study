...
#ifndef new_analyzer_h
#define new_analyzer_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   new_analyzer(TTree *tree=0);
   new_analyzer(const char* file1, const char* file2);
   virtual ~new_analyzer();
...
#ifdef new_analyzer_cxx
new_analyzer::new_analyzer(const char* file1, const char* file2)
{
...
Int_t new_analyzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t new_analyzer::LoadTree(Long64_t entry)
{
...
void new_analyzer::Init(TChain *tree)
{
...
void new_analyzer::Show(Long64_t entry)
{
...
Int_t new_analyzer::Cut(Long64_t entry)
{
