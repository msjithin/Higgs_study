...
then
    ...
    ./analyze_mutau_updated /hdfs/store/user/jmadhusu/MC2018_Autumn18_monoHiggs_23Jan/GluGluHToTauTau_M125_13TeV_powheg_pythia8/crab_job_GluGluHToTauTau/200122_102019/0000/ $outFile $nEvents 1000 2018_test MC
elif [ $sample == 'vbf' ]
then
    outFile="study_mutau_110k_vbf.root"
    echo "vbf sample analysis....."
    ./analyze_mutau_updated /hdfs/store/user/jmadhusu/MC2018_Autumn18_monoHiggs_23Jan/VBFHToTauTau_M125_13TeV_powheg_pythia8/crab_job_VBFHToTauTau/200203_183458/0000/ $outFile $nEvents 1000 2018_test MC
fi
