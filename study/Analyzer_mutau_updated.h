...
#ifndef Analyzer_mutau_updated_h
#define Analyzer_mutau_updated_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   //   Analyzer_mutau_updated(TTree *tree=0);
   Analyzer_mutau_updated(const char* file1, const char* file2);
   virtual ~Analyzer_mutau_updated();
   ...
   virtual vector<int> getTauCand(double pt, double eta, int mu_index, int &mu_selected);
...
#ifdef Analyzer_mutau_updated_cxx
Analyzer_mutau_updated::Analyzer_mutau_updated(const char* file1, const char* file2)
{
...
Analyzer_mutau_updated::~Analyzer_mutau_updated()
{
   if (!fChain) return;
...
Int_t Analyzer_mutau_updated::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Analyzer_mutau_updated::LoadTree(Long64_t entry)
{
...
void Analyzer_mutau_updated::Init(TChain *tree)
{
...
Bool_t Analyzer_mutau_updated::Notify()
{
...
void Analyzer_mutau_updated::Show(Long64_t entry)
{
...
Int_t Analyzer_mutau_updated::Cut(Long64_t entry)
{
...
#endif // #ifdef Analyzer_mutau_updated_cxx
