...
Histo_org=OutFile.Get(histoname+"_gen_org")
...
Histo_gen.GetYaxis().SetTitle("Events")
if yaxisLog == 1 :
  Histo_gen.SetMaximum(10*max(Histo_rec.GetMaximum(),Histo_gen.GetMaximum()))
  Histo_gen.SetMinimum(0.01)
else :
  Histo_gen.SetMaximum(1.35*max(Histo_rec.GetMaximum(),Histo_gen.GetMaximum()))
