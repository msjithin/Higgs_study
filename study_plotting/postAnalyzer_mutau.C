...
int main(int argc, char** argv)
{
  ...
  */
  ...
  TH1F* histo_HiggsPt_13 = (TH1F*)((TH1F*)f_input->Get("HiggsPt_13"))->Clone();
  TH1F* histo_HiggsPt_14 = (TH1F*)((TH1F*)f_input->Get("HiggsPt_14"))->Clone();
  ...
  TH1F *h_HiggsPt_7 = (TH1F*)histo_HiggsPt_7->Rebin(25,"Higgs_pt_7", Pt_Bins);
  TH1F *h_HiggsPt_8 = (TH1F*)histo_HiggsPt_8->Rebin(25,"Higgs_pt_8", Pt_Bins);
  TH1F *h_HiggsPt_9 = (TH1F*)histo_HiggsPt_9->Rebin(25,"Higgs_pt_9", Pt_Bins);
  TH1F *h_HiggsPt_10 = (TH1F*)histo_HiggsPt_10->Rebin(25,"Higgs_pt_10", Pt_Bins);
  TH1F *h_HiggsPt_11 = (TH1F*)histo_HiggsPt_11->Rebin(25,"Higgs_pt_11", Pt_Bins);
  TH1F *h_HiggsPt_12 = (TH1F*)histo_HiggsPt_12->Rebin(25,"Higgs_pt_12", Pt_Bins);
  TH1F *h_HiggsPt_13 = (TH1F*)histo_HiggsPt_13->Rebin(25,"Higgs_pt_13", Pt_Bins);
  TH1F *h_HiggsPt_14 = (TH1F*)histo_HiggsPt_14->Rebin(25,"Higgs_pt_14", Pt_Bins);

  histo_nEvents->Scale(net_weight);
  histo_dr_gen->Scale(net_weight);
  histo_Higgs_mass_gen->Scale(net_weight);
  h_HiggsPt_0->Scale(net_weight*0.23);
  h_HiggsPt_1->Scale(net_weight*0.46);//0.46
  h_HiggsPt_2->Scale(net_weight*0.73);//0.47
  ...
  h_HiggsPt_13->Scale(net_weight);
  h_HiggsPt_14->Scale(net_weight);
